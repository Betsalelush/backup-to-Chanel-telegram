...
קובץ lo.py הוא קובץ ששולח קיצור של קישורים לבוט
כי טלגרם החליטו משום מה לחסום קישורים ישירים 


קובץ meudcan2.py 
עם אפשרות לבחור מאיזה הודעה להעביר 

קובץ meudcan.py 
רק אפשרות מההתקדמות אחרונה או מההתחלה
ככל הניראה לא יודע להבדיל בין התקדמות בין ערוץ לערוץ 
